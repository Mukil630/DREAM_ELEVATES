  ...
  return (
    <div className="min-h-screen pt-24 pb-16 flex items-center justify-center px-4 sm:px-6 bg-[#26160D] text-[#FBF3EA] relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-10 right-10 w-96 h-96 bg-[#C9A15A]/25 rounded-full blur-[100px] pointer-events-none"
      />
      <motion.div
        animate={{
          scale: [1, 1.3, 1],
        ...
        className="absolute bottom-10 left-10 w-96 h-96 bg-[#B5476B]/25 rounded-full blur-[100px] pointer-events-none"
      />
      ...
      >
        ...
        <div className="lg:col-span-6 relative p-8 sm:p-12 flex flex-col justify-between overflow-hidden bg-gradient-to-br from-[#2A170C] via-[#3B2417] to-[#1E0F07]">
          ...
          <div className="relative z-10 my-12">
            ...
            >
              &ldquo;Crafting dream cakes that turn every celebration into an unforgettable memory.&rdquo;
            </motion.blockquote>
          ...
          <div className="relative z-10 pt-4 border-t border-[#FBF3EA]/15 flex items-center justify-between text-xs text-[#FBF3EA]/80 font-medium">
            <div className="flex items-center gap-2">
              ...
              <span>Unlock Member Privileges</span>
            </div>
            <span>📞 8883338935</span>
          </div>
        </div>

        {/* Right Side: Glassmorphism Signup Form (6 cols) */}
        <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-[#FBF3EA] text-[#3B2417] relative">
          ...
          <form onSubmit={handleSignup} className="space-y-3.5">
            <div>
              <label className="block text-xs font-bold text-[#5A3826] uppercase tracking-wider mb-1">
                Full Name *
              </label>
              <input
                type="text"
                ...
                className="w-full rounded-xl border border-[#3B2417]/20 bg-white/80 px-4 py-2.5 text-sm outline-none focus:border-[#B5476B] focus:ring-2 focus:ring-[#B5476B]/20 transition-all shadow-inner"
              />
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full mt-3 rounded-full bg-gradient-to-r from-[#e38c36] via-[#C9A15A] to-[#e38c36] bg-[length:200%_auto] text-[#24130A] py-3.5 text-sm font-extrabold shadow-lg hover:shadow-amber-500/25 transition-all duration-300"
            >
              Create Account &amp; Continue &rarr;
            </motion.button>
          </form>

          <div className="mt-5 text-center text-xs text-[#5A3826]">
            Already have an account?{" "}
            <Link href="/login" className="font-bold text-[#B5476B] hover:underline">
              Log In
            </Link>
          </div>
        </div>
